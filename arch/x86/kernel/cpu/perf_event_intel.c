...
EVENT_ATTR_STR_HT(topdown-slots-retired.aggr-per-core, td_slots_retired_pc,
	"0", "1");
EVENT_ATTR_STR(topdown-fetch-bubbles, td_fetch_bubbles,
	"event=0x9c,umask=0x1");		/* idq_uops_not_delivered_core */
EVENT_ATTR_STR_HT(topdown-fetch-bubbles.aggr-per-core, td_fetch_bubbles_pc,
	"0", "1");
...
EVENT_ATTR_STR_HT(topdown-recovery-bubbles.scale, td_recovery_bubbles_scale,
	"4", "2");
EVENT_ATTR_STR_HT(topdown-recovery-bubbles.aggr-per-core, td_recovery_bubbles_pc,
	"0", "1");
